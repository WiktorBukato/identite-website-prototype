'use strict';
// Contact and self-review share only page-memory state. No storage or network writes.
...
document.querySelectorAll('[data-contact]').forEach(contactForm => {
  ...
  const lists={intent:Object.keys(copy.intents),product:config.products,solution:config.solutions,source_page:config.routes,locale:config.locales};
